  ...
  const handleCreateProposal = async (data: any) => {
    try {
      ...
      const getCallData = (type: ProposalType) => {
        ...
        if (type === ProposalType.OffChain) {
          ...
          if (type === ProposalType.Fundraising) {
            console.log('gg', [
              ethers.utils.parseEther(data.goalAmount),
      ...
      const proposalResult = await PropertyGovernanceContract.propose(
        ...
        data.proposalType === ProposalType.OnChain
          ? data.targetAddress
        ...
        <form onSubmit={handleSubmit} className='space-y-8'>
          ...
          <div className='space-y-2'>
            ...
            <select
              value={formData.type}
              onChange={(e) =>
                handleTypeChange(Number(e.target.value) as ProposalType)
              }
